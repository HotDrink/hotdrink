...
have a foundation for understanding what HotDrink is doing without feeling
like it is \ldquo{}magic\rdquo.
...
makes clear what the property model is doing.
