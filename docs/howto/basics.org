...
variables.  Then click the "Get Result" button to see the value of the
/result/ variable.
...
<<emailsEdit>>
  ...
  // Obtain DOM node for displaying result
...
#+NAME: resultSpan
#+BEGIN_SRC js
  // Add event handler to variable which updates span
