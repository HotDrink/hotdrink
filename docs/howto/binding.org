...
instead of ~model: component.x~.  When evaluating your binding specification,
...
added to the DOM /before/ calling ~createDeclaredBindings~; therefore, it is
