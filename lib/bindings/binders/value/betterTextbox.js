(function () {
  ...
  var BetterTextbox = function BetterTextbox(tbox) {
    ...
    this.onStartEditing(function selectOnStart() {
  ...
  /*
  var onChange = function onChangeBetterTextbox(view, listener) {
    ASSERT(view instanceof BetterTextbox, "expected jQuery object");
  ...
  */
  ...
  hd.binders["btb"] = function bindBetterTextbox(view, options) {
    ...
    if (editing) {
      hd.binders["focused"](view.tbox, editing);
    }

    hd.binders["textbox"](view.tbox, value);
  };
