(function () {
  ...
  pt.maybePublishEdit = function maybePublishEdit(evt) {
    var text = this.getText();
    if (text === this.checkpoint) {
      return;
    }
    this.checkpoint = text;
    this.publish("edit", evt);
  };

  pt.privateSetText = function privateSetText(text) {
    this.tbox.val(text);
    this.checkpoint = text;
  };
  ...
  pt.insertText = function insertText(index, insertion) {
    ...
    this.privateSetText(before + insertion + after);
  ...
  pt.removeText = function removeText(begin, end) {
    ...
    this.privateSetText(before + after);
