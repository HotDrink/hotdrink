...
(function () {
  ...
  Controller.prototype.bindAny = function bindAny(view, bindings, context) {
    ...
    Object.keys(bindings).forEach(function (binderName) {
      ...
      var binding;
      if (hotdrink.isBinding(bindings[binderName]))
        binding = bindings[binderName];
      else
        binding= new hotdrink.model.Binding(bindings[binderName]);

      if (binder.call(this, view, binding, context)) {
        doNotRecurse = true;
      }
    }, this);
