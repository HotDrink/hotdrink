...
(function () {
  ...
  var subbindText = common.binder(
    common.write, onChange, common.getValue, common.convert, common.validate, common.enable, common.disable);

  var bindText = function bindText(view, model, binding, controller) {
    var hdtSaved = HOTDRINK_DEBOUNCE_THRESHOLD;

    if (binding.debounce) HOTDRINK_DEBOUNCE_THRESHOLD = binding.debounce;
    subbindText(view, model, binding, controller);
