/**
 * @fileOverview <p>{@link hotdrink.model.behavior.Activation}</p>
 * @author John Freeman
 */

//provides("hotdrink.model.behavior.Activation");
...
(function () {
  ...
  Activation.prototype.variable = function variable(vv) {
    if (vv.cellType === "output") {
      ASSERT(!contains(this.outputs, vv),
   ...
   */
  namespace.open("hotdrink.model.behavior").Activation = Activation;
