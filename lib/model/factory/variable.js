...
(function () {
   ...
   *   array.
   */
  Factory.prototype.computed = function computed(fn, set) {
    var vv = this.addComputedVariable("logic", fn);
    return hotdrink.model.makeComputedProxy(vv, this.runtime, set);
  };
  ...
  Factory.prototype.binding = function binding(options) {
    return this.addBinding(options);
  }
