(function () {
  ...
  var push = function push() {
    ...
    vv.draft("value").push({
      add: { index: vv.value.length, howMany: arguments.length }
    });
  ...
  var splice = function splice(index, howMany/*, ...*/) {
    ...
    if (arguments.length > 2) {
      vv.draft("value").push({
        add: { index: index, howMany: (arguments.length - 2) }
      });
    }
  ...
  var unshift = function unshift() {
    ...
    vv.draft("value").push({
      add: { index: 0, howMany: arguments.length }
    });
  ...
  var remove = function remove(/*...*/) {
    ...
    prune.call(this, function (item) { return args.has(item); });
  };
