...
DEBUG_DEFINE([LOG],[diag.log("m4___file__:m4___line__: " + $*);])

DEBUG_DEFINE([INSPECT],[diag.log($*);])
...
DEBUG_DEFINE([WARNING],[diag.warning("m4___file__:m4___line__: " + M4_JOINALL(<{, }>,$*));])

DEBUG_DEFINE([WARNINGIF],
[if ($1) {
  WARNING(<{m4_shift($*)}>);
}])

# Works much like error() in GCC.
DEBUG_DEFINE([ERROR],[diag.error("m4___file__:m4___line__: " + M4_JOINALL(<{, }>,$*));])
